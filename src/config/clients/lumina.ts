...
// Configuración de negocio de Lumina Estética.
// Para crear un cliente nuevo: copiá este archivo a src/config/clients/<nombre>.ts,
// reemplazá cada valor y sumalo al resolver en src/config/site.ts.
export const luminaConfig = {
  theme: {
    // Selecciona el bloque de colores en globals.css ([data-brand="lumina"])
  ...
  business: {
    ...
    monogram: "L",
    // Etiqueta corta de rubro, usada en la píldora del hero ("Centro de estética en Buenos Aires").
    categoryLabel: "Centro de estética",
    slogan: "Tu mejor versión empieza acá.",
    subSlogan:
      "Tratamientos personalizados, tecnología y profesionales que se enfocan en vos.",
    // Título principal del hero, partido en dos líneas (la segunda en itálica/acento).
    heroHeadline: {
      line1: "Tu mejor versión",
      accentLine: "empieza acá.",
    },
    // Textos del panel visual del hero (ArtPanel).
    heroVisual: {
